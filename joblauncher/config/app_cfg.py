# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in joblauncher.
...
from joblauncher.lib import app_globals, helpers

base_config = AppConfig()
base_config.renderers = []
base_config.package = joblauncher
...
def on_shutdown():
    print '--- stopping joblauncher application --- '
